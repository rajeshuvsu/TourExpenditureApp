...
# --- Callback for clearing new person text input ---
...
with st.sidebar:
    ...
    if st.button("Add Person", on_click=clear_new_person):
...
# --- Callback for clearing expense form on submit (using rerun) ---
def clear_expense_form():
    for key in ("amount", "remarks"):
...
with st.form("Add Expense", clear_on_submit=True):
    ...
    if submitted:
        ...
        # The clear_on_submit resets the fields!
